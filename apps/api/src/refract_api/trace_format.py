...
an importer/exporter for Refract's trace format should be able to fetch the
canonical JSON Schema without cloning this repo or reading Python source.
The file itself is generated from refract_core.trace.TraceFile (see
...
# apps/api/src/refract_api/trace_format.py -> repo root -> docs/
