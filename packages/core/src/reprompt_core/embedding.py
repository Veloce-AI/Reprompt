...
Per reprompt-parity-engine-plan.md §3 ("Evaluation Engine"), a stage's score
is a weighted blend::
...
"""Default local embedding model, per reprompt-parity-engine-plan.md §2/§10.
...
def _load_model(model_name: str) -> "SentenceTransformer":
    ...
    that importing ``reprompt_core.embedding`` (or ``reprompt_core`` as a
